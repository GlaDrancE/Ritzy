  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-gray-50 px-8 md:px-16 lg:px-20 py-16 md:py-24">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative w-full h-96 lg:h-[500px] bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl overflow-hidden">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
                  Let&apos;s see how your home can evolve with smart automation
                </h2>
                <p className="text-gray-600 text-lg md:text-xl leading-relaxed">
                  Experience the future of home living with our intelligent
                  automation systems designed for smarter, more convenient, and
                  secure living.
                </p>
              </div>
      ...
      <div className="relative w-full min-h-screen overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 h-full flex items-center justify-center px-8 md:px-16 lg:px-20 py-16 md:py-24">
          <div className="w-full max-w-6xl">
            {/* Glassmorphism Dialog Box */}
            <div className="relative">
              <div className="backdrop-blur-xl bg-white bg-opacity-10 border border-white border-opacity-20 rounded-3xl overflow-hidden shadow-2xl">
                <div className="flex flex-col lg:flex-row">
                  {/* Left Side - Image/Visual */}
                  <div className="lg:w-1/2 bg-gray-100 bg-opacity-20">
                    <div className="flex flex-col items-center justify-center space-y-6 relative md:h-[27rem]">
      ...
      <div className="w-full min-h-screen bg-white px-8 md:px-16 lg:px-20 py-16 md:py-24">
            ...
            <div className="space-y-8">
              ...
              <div className="max-w-md">
                <p className="text-gray-700 text-sm md:text-sm leading-relaxed">
                  We are driven by a passion for perfection and a dedication to
            ...
            <div className="space-y-8 lg:space-y-12">
              ...
              <div className="max-w-sm">
                <p className="text-gray-700 text-sm md:text-sm leading-relaxed">
                  ...
                  Lifestyle brings smart home and office automation to life with
                  innovative designs, shaping modern living spaces as of July
                  2025.
                </p>
              </div>
              ...
              <div className="max-w-lg">
                <p className="text-gray-700 text-sm md:text-sm leading-relaxed w-1/2">
                  Rooted in cutting-edge technology and a passion for luxury, we
                  transform serene, upscale environments into connected
      ...
      <div className="relative w-full min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-8 md:px-16 lg:px-20 py-16 md:py-24">
          <div className="w-full max-w-4xl">
            {/* Glassmorphism Card */}
            <div className="backdrop-blur-xl bg-black bg-opacity-20 border border-white border-opacity-20 rounded-3xl overflow-hidden shadow-2xl p-12 md:p-16">
              {/* Brand Identifier */}
